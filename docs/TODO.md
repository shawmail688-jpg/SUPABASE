...
- [ ] TASK-012 领导视图+Realtime（IN REVIEW：真实坐标 Atlas、店面照片/灯箱、风水摘要卡、索引/飞行定位/弹窗、同钉错开、hidden 排除与 archived 保留已实现；GAS 6 家可见店面坐标已补写 Supabase；Realtime/archived admin 留真实 E2E）
