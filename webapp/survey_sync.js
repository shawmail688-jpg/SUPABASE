...
function supaResolveSite(jwt, code, name, grp, address) {
  return supaFetch(jwt, "/rest/v1/rpc/resolve_form_site", {
    ...
    if (site.site_status === "archived" || site.site_status === "hidden") { var err = new Error("This store is hidden or archived. Contact an administrator before submitting."); err.code = "ARCHIVED"; throw err; }
